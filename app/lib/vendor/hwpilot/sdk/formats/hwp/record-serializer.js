import { controlIdBuffer } from './control-id.js';
import { parseRecordHeader } from './record-parser.js';
...
function nextTableInstanceId() {
    return ++tableInstanceIdCounter >>> 0;
}
export function buildTableCtrlHeaderData(instanceId) {
