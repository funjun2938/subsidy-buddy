import CFB from 'cfb';
import { parseRef } from '../../../sdk/refs.js';
import { readControlId } from './control-id.js';
import { parseCellAddress, parseStyleRefs } from './docinfo-parser.js';
import { iterateRecords } from './record-parser.js';
import { buildCellListHeaderData, buildParaLineSegBuffer, buildRecord, buildTableCtrlHeaderData, buildTableData, replaceRecordData, } from './record-serializer.js';
import { compressStream, decompressStream } from './stream-util.js';
import { TAG } from './tag-ids.js';
...
function spliceRecordsAtParagraph(stream, paragraphIndex, position, newRecords) {
